...
fn empty_lists() {
    let list_one: &[i32] = &[];
    let list_two: &[i32] = &[];
    let output = sublist_pattern_matching(list_one, list_two);
...
#[test]
fn sublist_pattern_matching_at_start() {
...
#[test]
fn sublist_pattern_matching_in_middle() {
...
#[test]
fn sublist_pattern_matching_at_end() {
